...
def autoencoder1DTranspose(batch_size, input_shape, frame_size):
    ...
    ENC = Conv1D(2, frame_size, strides=2, padding='same', activation='tanh', kernel_initializer='truncated_normal', bias_initializer='truncated_normal')(X)
    ...
    DEC = Conv1DTranspose(ENC, 8, frame_size, strides=2, padding='same', activation='tanh', kernel_initializer='truncated_normal', bias_initializer='truncated_normal')
...
def autoencoder1D(batch_size, input_shape, frame_size):
    ...
    ENC = Conv1D(2, frame_size, padding='same', activation='tanh', kernel_initializer='truncated_normal', bias_initializer='truncated_normal')(X)
    ...
    DEC = Conv1D(8, frame_size, padding='same', activation='tanh', kernel_initializer='truncated_normal', bias_initializer='truncated_normal')(ENC)
